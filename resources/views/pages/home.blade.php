        ...
        <section class="welcome-section none">
            <div class="container welcome-container">
                ...
                <div class="welcome-left">
                    ...
                    <img class="welcome-hand" src="{{asset('img/hand.png')}}">
                    <img class="welcome-hand red-hand" src="{{asset('img/hand-red.png')}}">
                </div>
            </div>
        </section>
                ...
                <div class="whywe-inner">
                    ...
                    <ul class="whywe-list">
                        <li class="whywe-list-item">
                            ...
                            <h3 class="whywe-list-title">Сопровождение</h3>
                            <p class="whywe-list-subtitle">На протяжении всей жизни программы</p>
                        </li>
                        <li class="whywe-list-item">
                            ...
                            <h3 class="whywe-list-title">Эффективная работа</h3>
                            <p class="whywe-list-subtitle">Быстро, качественно и продуктивно</p>
                        </li>
                        <li class="whywe-list-item">
                            <div class="whywe-list-icon">
                            ...
                            <h3 class="whywe-list-title">Клиентоориентированность</h3>
                            <p class="whywe-list-subtitle">Ваш успех - наша цель</p>
                        </li>
                    </ul>
                    ...
                    <ul class="advantages-list">
                        <li class="advantages-list-item">
                            ...
                            Полный комплекс услуг по автоматизации
                        </li>
                        <li class="advantages-list-item">
                            <svg width="24" height="13" viewBox="0 0 24 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.2999 0.300285C16.9099 -0.0897146 16.2799 -0.0897146 15.8899 0.300285L10.2499 5.94028L11.6599 7.35029L17.2999 1.70029C17.6799 1.32029 17.6799 0.680285 17.2999 0.300285ZM21.5399 0.290285L11.6599 10.1703L8.17989 6.70028C7.78989 6.31029 7.15989 6.31029 6.76989 6.70028C6.37989 7.09028 6.37989 7.72028 6.76989 8.11028L10.9499 12.2903C11.3399 12.6803 11.9699 12.6803 12.3599 12.2903L22.9499 1.71029C23.3399 1.32029 23.3399 0.690285 22.9499 0.300285H22.9399C22.5599 -0.0997146 21.9299 -0.0997148 21.5399 0.290285ZM1.11989 8.12029L5.29989 12.3003C5.68989 12.6903 6.31989 12.6903 6.70989 12.3003L7.40989 11.6003L2.52989 6.70028C2.13989 6.31029 1.50989 6.31029 1.11989 6.70028C0.729893 7.09028 0.729893 7.73029 1.11989 8.12029Z" fill="#10B981"/>
                        ...
                        <li class="advantages-list-item">
                            ...
                            Соблюдение срока и бюджета проекта
                        </li>
                        <li class="advantages-list-item">
                            <svg width="24" height="13" viewBox="0 0 24 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.2999 0.300285C16.9099 -0.0897146 16.2799 -0.0897146 15.8899 0.300285L10.2499 5.94028L11.6599 7.35029L17.2999 1.70029C17.6799 1.32029 17.6799 0.680285 17.2999 0.300285ZM21.5399 0.290285L11.6599 10.1703L8.17989 6.70028C7.78989 6.31029 7.15989 6.31029 6.76989 6.70028C6.37989 7.09028 6.37989 7.72028 6.76989 8.11028L10.9499 12.2903C11.3399 12.6803 11.9699 12.6803 12.3599 12.2903L22.9499 1.71029C23.3399 1.32029 23.3399 0.690285 22.9499 0.300285H22.9399C22.5599 -0.0997146 21.9299 -0.0997148 21.5399 0.290285ZM1.11989 8.12029L5.29989 12.3003C5.68989 12.6903 6.31989 12.6903 6.70989 12.3003L7.40989 11.6003L2.52989 6.70028C2.13989 6.31029 1.50989 6.31029 1.11989 6.70028C0.729893 7.09028 0.729893 7.73029 1.11989 8.12029Z" fill="#10B981"/>
                            </svg>
                            Понимание бизнеса заказчика
                        </li>
                        <li class="advantages-list-item">
                            <svg width="24" height="13" viewBox="0 0 24 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.2999 0.300285C16.9099 -0.0897146 16.2799 -0.0897146 15.8899 0.300285L10.2499 5.94028L11.6599 7.35029L17.2999 1.70029C17.6799 1.32029 17.6799 0.680285 17.2999 0.300285ZM21.5399 0.290285L11.6599 10.1703L8.17989 6.70028C7.78989 6.31029 7.15989 6.31029 6.76989 6.70028C6.37989 7.09028 6.37989 7.72028 6.76989 8.11028L10.9499 12.2903C11.3399 12.6803 11.9699 12.6803 12.3599 12.2903L22.9499 1.71029C23.3399 1.32029 23.3399 0.690285 22.9499 0.300285H22.9399C22.5599 -0.0997146 21.9299 -0.0997148 21.5399 0.290285ZM1.11989 8.12029L5.29989 12.3003C5.68989 12.6903 6.31989 12.6903 6.70989 12.3003L7.40989 11.6003L2.52989 6.70028C2.13989 6.31029 1.50989 6.31029 1.11989 6.70028C0.729893 7.09028 0.729893 7.73029 1.11989 8.12029Z" fill="#10B981"/>
                            </svg>
                            Выгодные для клиентов цены
                        </li>
                        <li class="advantages-list-item">
                            <svg width="24" height="13" viewBox="0 0 24 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.2999 0.300285C16.9099 -0.0897146 16.2799 -0.0897146 15.8899 0.300285L10.2499 5.94028L11.6599 7.35029L17.2999 1.70029C17.6799 1.32029 17.6799 0.680285 17.2999 0.300285ZM21.5399 0.290285L11.6599 10.1703L8.17989 6.70028C7.78989 6.31029 7.15989 6.31029 6.76989 6.70028C6.37989 7.09028 6.37989 7.72028 6.76989 8.11028L10.9499 12.2903C11.3399 12.6803 11.9699 12.6803 12.3599 12.2903L22.9499 1.71029C23.3399 1.32029 23.3399 0.690285 22.9499 0.300285H22.9399C22.5599 -0.0997146 21.9299 -0.0997148 21.5399 0.290285ZM1.11989 8.12029L5.29989 12.3003C5.68989 12.6903 6.31989 12.6903 6.70989 12.3003L7.40989 11.6003L2.52989 6.70028C2.13989 6.31029 1.50989 6.31029 1.11989 6.70028C0.729893 7.09028 0.729893 7.73029 1.11989 8.12029Z" fill="#10B981"/>
        ...
        <section class="feedback-section none">
            <div class="container feedback-section-container">
                ...
                <form class="feedback-form">
                    ...
                    <label class="feedback-label">
                        <input class="feedback-input" name="phone" type="number" placeholder="Ваш телефон" autocomplete="off">
                    </label>
                    <div class="feedback-btn-wrapper">
                        <button class="button button--red feedback-submit-btn" type="submit">
                        ...
                        <div class="button feedback-fail-msg">
                        ...
                        <div class="button feedback-success-msg">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <img class="feedback-section-hand" src="{{asset('img/hand.png')}}">
